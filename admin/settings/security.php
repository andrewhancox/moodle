...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $sitepolicyoptions = array(
        SITEPOLICY_NONE => new lang_string('none', ''),
        SITEPOLICY_EXTERNALURL => new lang_string('sitepolicyoptionexternalurl', 'admin'),
        SITEPOLICY_TEXT => new lang_string('sitepolicyoptiontext', 'admin')
    );
