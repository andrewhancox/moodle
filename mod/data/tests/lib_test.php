...
class mod_data_lib_testcase extends advanced_testcase {
    ...
    public function test_mod_data_get_tagged_records() {
        ...
        $this->assertRegExp("/recordid=$record11&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record12&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record13&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record14&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record15&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record16&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record21&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record22&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record23&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record31&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record41&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record51&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record52&amp;/", $res->content);
        $this->assertEmpty($res->prevpageurl);
        $this->assertNotEmpty($res->nextpageurl);
        $res = mod_data_get_tagged_records($tag, /*$exclusivemode = */false,
            /*$fromctx = */0, /*$ctx = */0, /*$rec = */1, /*$record = */1);
        $this->assertNotRegExp("/recordid=$record11&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record12&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record13&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record14&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record15&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record16&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record21&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record22&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record23&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record31&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record41&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record51&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record52&amp;/", $res->content);
        ...
        $this->assertNotRegExp("/recordid=$record31&amp;/", $res->content);
        $this->assertNotRegExp("/recordid=$record41&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record51&amp;/", $res->content);
        $this->assertRegExp("/recordid=$record52&amp;/", $res->content);
        $this->assertNotEmpty($res->prevpageurl);
