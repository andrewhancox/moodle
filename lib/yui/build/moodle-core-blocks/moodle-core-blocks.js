...
Y.extend(DRAGBLOCK, M.core.dragdrop, {
    ...
    initialfollowingsibling : null,
    initialprecedingsibling : null,
    initialparent : null,
    ...
    drag_start : function(e) {
        ...
        if (this.skipnodetop) {
            this.initialprecedingsibling = this.skipnodetop.previous();
        }
        if (this.skipnodebottom) {
            this.initialfollowingsibling = this.skipnodebottom.next();
        }
        this.initialparent = drag.get('node').get('parentNode');
            ...
            on: {
                ...
                success: function(tid, response) {
                    ...
                    try {
                        ...
                        if (responsetext.error === 'locked') {
                            if (this.initialfollowingsibling) {
                                this.initialfollowingsibling.insert(dragnode, "before");
                            } else if (this.initialprecedingsibling) {
                                this.initialfollowingsibling.insert(dragnode, "after");
                            } else if (this.initialparent) {
                                this.initialparent.append(dragnode);
                            }
                            if (this.skipnodetop) {
                                dragnode.insert(this.skipnodetop, 'before');
                            } else if (this.skipnodebottom) {
                                dragnode.insert(this.skipnodebottom, 'after');
                            }
        ...
        Y.io(M.cfg.wwwroot+AJAXURL, {
            ...
            on: {
                ...
                success: function(tid, response) {
                    ...
                    try {
                        var responsetext = Y.JSON.parse(response.responseText);
                        if (responsetext.responseText.error === 'locked') {
                            if (this.initialfollowingsibling) {
                                this.initialfollowingsibling.insert(dragnode, "before");
                            } else if (this.initialprecedingsibling){
                                this.initialfollowingsibling.insert(dragnode, "after");
