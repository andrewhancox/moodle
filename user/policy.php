...
switch ($sitesitepolicysource) {
    ...
    case SITEPOLICY_EXTERNALURL:
        ...
        $url = new moodle_url($sitepolicyurl);
        ...
        $clicktoopen = '<a href="' . $url . '" onclick="this.target=\'_blank\'">' . $strpolicyagreementclick . '</a>';
        $sitepolicy = resourcelib_embed_general($url, $strpolicyagreement, $clicktoopen, $mimetype);
        break;
